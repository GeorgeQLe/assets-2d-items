...
2D generic game items (weapons, potions, loot, collectibles)
...
|------|--------|---------|------|
| Kenney Generic Items | 332 | CC0-1.0 | [Link](https://kenney.nl/assets/generic-items) |
...
├── manifest.json     # Machine-readable asset index (332 entries)
